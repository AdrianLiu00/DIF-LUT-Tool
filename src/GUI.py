...
func_dict = {"Cosine": 'cos', "ELU": 'elu', "GELU": 'gelu', "SiLU": 'silu', "Sigmoid": 'sigmoid', "Sine": 'sin', "Tanh": 'tanh', "Exp_-x": 'exp_-x'}
...
def gui(runtime: Callable):
    ...
    combobox['values'] = ("Cosine", "ELU", "GELU", "SiLU", "Sigmoid", "Sine", "Tanh", "Exp_-x")
